...
class LevelHScene: PlayScene{
    ...
    override func setupMap(){
        ...
        let moveup = SKAction.moveBy(CGVectorMake(0,(self.size.height / 4)), duration: 1.0)
        let movedown = SKAction.moveBy(CGVectorMake(0,-(self.size.height / 4)), duration: 1.0)
        ...
        puffer1.runAction(repeatUDMove)
